...
int main()
{
    ...
    {
        printf("\t\t\t\t\t------ CALCULADORA ------\n\n");
        //si se cumple la condicion muestra A=numero , y sino A=x //
        if(flagA==1)
        {
        ...
        //si se cumple la condicion muestra B=numero , y sino B=y //
        if(flagB==1)
        {
        ...
        switch(opcion)
        {
            ...
            case 7:
                ...
                resFactorial=factorial(numero1);
                // muestro el resultado solamente si devuelve 0 la funcion factorial//
                if(resFactorial>0)
                {
                   printf("El resultado del factorial es: %.0lli \n",resFactorial);
                }
                break;
